...
# When running as a PyInstaller application, use the bundled Resources
# directory as the working directory. Tuxemon loads mod metadata and other
# resources using paths relative to the current working directory.
